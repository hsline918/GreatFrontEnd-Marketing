...
export default function NewsletterSection() {
  return (
    <section className="m-4 py-8 md:py-16 3xl:py-24 px-3 md:px-4 3xl:px-24 bg-white rounded-md shadow-soft ">
      <figure className="flex flex-col items-center 3xl:grid 3xl:grid-cols-2 3xl:items-center 3xl:justify-items-center gap-4 md:gap-16">
          ...
          <form className="flex flex-col md:flex-row gap-4">
            <div className="flex flex-col gap-3 md:gap-4">
              <input
                ...
                className="text-ellipsis text-sm bg-neutral-50 py-[0.625rem] px-[0.875rem] rounded ring-1 ring-neutral-200 placeholder:text-neutral-500 focus:outline-none focus:ring-2 focus:ring-indigo-700"
              />
        ...
        <ResponsiveImage
          ...
          className="mr-2 md:mr-4 bg-cover md:rounded-xl md:w-[43rem] md:h-[38rem] 3xl:w-[37rem] 3xl:h-[38rem]"
